...
| Testing      | Vitest (4308 passing tests across 99 discovered files), Storybook 8 (231 stories with `play()` interaction tests), Playwright E2E (2 spec files) |
...
- **4308 passing tests** + **3 skipped** across **99 discovered test files**
