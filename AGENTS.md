...
| Testing      | Vitest (4084 tests across 81 files), Storybook 8 (~105+ stories with `play()` interaction tests), Playwright E2E (2 spec files) |
...
- **4084 tests** across **81 test files** — all passing
