...
export const djinn: CharacterDef = {
  id: 'djinn',
  name: 'Djinn',
  type: 'Fabled',
  defaultAlignment: 'Good',
  abilityShort: "Use the Djinn's special rule. All players know what it is.",
  abilityDetailed: `Add the Djinn to all games with a jinx icon on the script. The Djinn resolves jinxes by creating a unique rule.
...
• The Djinn may have several special rules at once. If there are multiple pairs of jinxed characters on the character sheet, the players learn all the Djinn’s special rules.`,
  wikiLink: 'https://wiki.bloodontheclocktower.com/Djinn',
  firstNight: null,
  otherNights: null,
  icon: {
